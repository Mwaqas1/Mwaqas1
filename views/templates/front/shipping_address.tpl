                        ...
                        {else}
                            ...
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    <label class="control-label" for="shipping_address[{$p_address_key}]" {if $p_address_key eq "postcode"} style="font-size: 12px;"{/if}>{l s={$settings['shipping_address'][$p_address_key]['title']} mod='supercheckout'}: 
