                                                    ...
                                                    <div class="modal-dialog" style="width:50%">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="padding-bottom:0;">
                                                                            ...
                                                                            <tr class="supercheckout_custom_field_form_fields">
                                                                                ...
                                                                                <td class="supercheckout_popup_form_field">
                                                                                    <div class="span">
                                                                                        <span class='float_left margin_right_20'>
                                                                                            {foreach $languages as $language}
                                                                                                <input class="required_entry supercheckout_customer_profiles {if $language_current neq $language['id_lang']}hidden_custom{/if}" type="text" id='customer_profiles_language_{$language['id_lang']}' name="customer_profiles[field_label][{$language['id_lang']}]">
                                                                                            {/foreach}
                                                                                        </span>
                                                                                        <span class='float_left'>
                                                                ...
                                                                {foreach from=$velocity_supercheckout['shipping_address'] key='k' item = 'p_addr'}
                                                                    <tr id="customer_personal_{$velocity_supercheckout['shipping_address'][$k]['id']}_input" class="" >
                                                                <input type="hidden" value="{$velocity_supercheckout['shipping_address'][$k]['id']}" name="customer_profiles[profile_shipping_address][{$k}][id]" />
                                                                <input type="hidden" value="{$velocity_supercheckout['shipping_address'][$k]['title']}" name="customer_profiles[profile_shipping_address][{$k}][title]" />
                                                                <input type="hidden" value="{$velocity_supercheckout['shipping_address'][$k]['conditional']}" name="customer_profiles[profile_shipping_address][{$k}][conditional]" />
                                                                ...
                                                                <td class="left drag-col-2 col-pad-left">
                                                                    <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                        <label class="checkboxinline no-bold">
                                                                            ...
                                                                            {else}
                                                                                <input id="customer_shipping_address_guest_{$k}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field" name="customer_profiles[profile_shipping_address][{$k}][logged][require]" value="1" checked="checked" />{l s='Require' mod='supercheckout'}
                                                                            {/if}
                                                                        </label>
                                                                        <label class="checkboxinline no-bold">
                                                                            <input id="customer_shipping_address_guest_{$k}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field" name="customer_profiles[profile_shipping_address][{$k}][logged][display]" value="1" checked="checked" />{l s='Show' mod='supercheckout'}                                                                        
                                                                        </label>
                                                                        {if in_array($k, $highlighted_fields)}
                                                                            <span style="color:red; margin-left: 5px;">*</span>
                                                                        {/if}
                                                            ...
                                                            {foreach from=$velocity_supercheckout['payment_address'] key='k' item = 'p_addr'}
                                                                    <tr id="customer_personal_{$velocity_supercheckout['payment_address'][$k]['id']}_input" class="" >
                                                                <input type="hidden" value="{$velocity_supercheckout['payment_address'][$k]['id']}" name="customer_profiles[profile_payment_address][{$k}][id]" />
                                                                <input type="hidden" value="{$velocity_supercheckout['payment_address'][$k]['title']}" name="customer_profiles[profile_payment_address][{$k}][title]" />
                                                                <input type="hidden" value="{$velocity_supercheckout['payment_address'][$k]['conditional']}" name="customer_profiles[profile_payment_address][{$k}][conditional]" />
                                                                <td style="text-align: center;">
                                                                    <span>{l s=$velocity_supercheckout['payment_address'][$k]['title'] mod='supercheckout'}:
                                                                ...
                                                                <td class="left drag-col-2 col-pad-left">
                                                                    <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                        <label class="checkboxinline no-bold">
                                                                            ...
                                                                            {else}
                                                                                <input id="customer_payment_address_guest_{$k}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field" name="customer_profiles[profile_payment_address][{$k}][logged][require]" value="1" checked="checked" />{l s='Require' mod='supercheckout'}
                                                                            {/if}
                                                                        </label>
                                                                        <label class="checkboxinline no-bold">
                                                                            <input id="customer_payment_address_guest_{$k}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field" name="customer_profiles[profile_payment_address][{$k}][logged][display]" value="1" checked="checked" />{l s='Show' mod='supercheckout'}                                                                        
                                                                        </label>
                                                                        {if in_array($k, $highlighted_fields)}
                                                                            <span style="color:red; margin-left: 5px;">*</span>
                                                                        {/if}
                                                    ...
                                                    <div class="block">
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td class="settings">
                                                                    ...
                                                                    {if $velocity_supercheckout['enable_customer_profile'] eq 1}
                                                                        {if $IE7 eq true}
                                                                            <div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="left settings">
                                                                    <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                        <label class="radio coupon_type_radio">
                                                                            <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[customer_profile_option]" value="0"  {if $velocity_supercheckout['customer_profile_option'] eq 0} checked="checked" {/if} />{l s='Dropdown' mod='supercheckout'}                                                                        
                                                                        </label>
                                                                        <label class="radio coupon_type_radio">
                                                                            <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[customer_profile_option]" value="1" {if $velocity_supercheckout['customer_profile_option'] eq 1} checked="checked" {/if} />{l s='Radio' mod='supercheckout'}                                                                        
                                                                        </label>
                                                            ...
                                                            <table class="table_custom_bordered" id="table_customer_profile_data" style="{*width: 80%; margin-left: 10%;*}">
                                                                ...
                                                                <tbody id="tbody_customer_profile_data">
                                                                    ...
                                                                    {foreach from=$customer_profile_datas item=array_field}
                                                                        <tr class="pure-table-odd" id="tr_pure_table_{$array_field['id_profile']}">
                                                                            <td class="center">{$counter}</td>
                                                                            <td class="width_25 center"><div class="div_250px_ellipsis">{$array_field['field_label']}</div></td> 
                                                                            <td class="center">{if $array_field['active'] eq '1'}{l s='Yes' mod='supercheckout'}{else}{l s='No' mod='supercheckout'}{/if}</td>
                                                                            <td class="center" style="padding: 12px;">
                                                                                <a style="margin-top: -26px;" href="javascript://" onclick="displayEditCustomerProfilePopup({$array_field['id_profile']})" type="11" class="velsof-glyphicons2 glyphicons pencil"><i title="{l s='Edit this custom field' mod='supercheckout'}"></i></a>                        '                                                                        
                                                                                <a style="margin-top: -26px;" href="javascript://" onclick="deleteCustomerProfileRow({$array_field['id_profile']})" type="11" class="velsof-glyphicons2 glyphicons bin"><i title="{l s='Delete this custom field' mod='supercheckout'}"></i></a>
                                                                            </td>
                                                                        </tr>
