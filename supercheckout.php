...
//        Tools::dieObject($parentTab, true);
    ...
    {
//        print_r(Tools::unSerialize(Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMER_PROFILE')));
//        die;
                ...
                switch (Tools::getValue('customer_profile_action')) {
                    case 'addCustomerProfileForm':
                        ...
                        if (isset($post_data['id_profile']) && $post_data['id_profile'] == 0) {
                            $profile_data = Tools::unSerialize(Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMER_PROFILE'));
                        ...
                        $json['response'] = Configuration::updateValue('VELOCITY_SUPERCHECKOUT_CUSTOMER_PROFILE', serialize($profile_data));
                        if ($json['response']) {
                    ...
                    case 'deleteCustomerProfileRow':
                        ...
                        $existing_profile_datas = Tools::unSerialize(Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMER_PROFILE'));
                        ...
                        $json['response'] = Configuration::updateValue('VELOCITY_SUPERCHECKOUT_CUSTOMER_PROFILE', serialize($existing_profile_datas));
                        break;
