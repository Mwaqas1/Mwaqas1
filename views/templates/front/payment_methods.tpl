            ...
            <li style="display: contents;">
                <div class="radio ">
                    <div id="{$option.id}-container">
                        <input type="radio" name="payment_method" style="height: auto" data-module-name="{$option.module_name nofilter}{*escape not required as contains html*}" value="{$option.id}" id="{$option.id}" {if $option.id_module == $selected_payment_method}checked="checked" {elseif $option.id == $selected_payment_method} checked="checked"{/if} class="{if $option.binary}binary{/if}"/>
