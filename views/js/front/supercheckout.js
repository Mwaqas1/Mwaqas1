...
function updateCarrierOnDeliveryChange() {
    ...
    $.ajax({
        ...
        cache: false,
        dataType: "json",
        data: 'ajax=true&delivery_available=' + delivery_available + delivery_option + '&method=updateCarrier&token=' + prestashop.static_token,
        beforeSend: function() {
            $('#shipping_method_update_warning .permanent-warning').remove();
            $('.kb_velsof_sc_overlay').show();$('.pay-loader').show();
            $('#shippingMethodLoader').show();
...
//            if (payment_module_name == 'ps_checkout-card') {
//                $('#supercheckout_confirm_order').hide();
//                $('#payment_methods_binaries').show();
//                $('.js-payment-ps_checkout-paypal').hide();
//                $('.js-payment-ps_checkout-mybank').hide();
//                //$('.js-payment-ps_checkout-sofort').hide();
//                $('.js-payment-ps_checkout-card').show();
//                $('.js-payment-ps_checkout-card .accept-cgv').show();
//                
//                 if (typeof $('input[name="conditions_to_approve[terms-and-conditions]"]:checked').val() == 'undefined'){
//                $('#ps_checkout-card-buttons-container').css("pointer-events", "none");
//                 }
//                 $('input[name="conditions_to_approve[terms-and-conditions]"]').click();
//            
//            } 
////            else if (payment_module_name == 'ps_checkout-mybank') {
////                $('#supercheckout_confirm_order').hide();
////                $('#payment_methods_binaries').show();
////                $('.js-payment-ps_checkout-card').hide();
////                $('.js-payment-ps_checkout-paypal').hide();
////                //$('.js-payment-ps_checkout-sofort').hide();
////                $('.js-payment-ps_checkout-mybank').show();
////                $('.js-payment-ps_checkout-mybank .accept-cgv').show();
////                
////                
////                if (typeof $('input[name="conditions_to_approve[terms-and-conditions]"]:checked').val() == 'undefined'){
////                    $('#ps_checkout-mybank-buttons-container').css("pointer-events", "none");
////                }
////                //$('input[name="conditions_to_approve[terms-and-conditions]"]').click();
////            } 
//            else if (payment_module_name == 'ps_checkout-paypal') {
//                $('#supercheckout_confirm_order').hide();
//                $('#payment_methods_binaries').show();
//                $('.js-payment-ps_checkout-card').hide();
//                $('.js-payment-ps_checkout-mybank').hide();
//                //$('.js-payment-ps_checkout-sofort').hide();
//                $('.js-payment-ps_checkout-paypal').show();
//                $('.js-payment-ps_checkout-paypal .accept-cgv').show();
//                
//                 if (typeof $('input[name="conditions_to_approve[terms-and-conditions]"]:checked').val() == 'undefined'){
...
//            }
//            if (typeof $('input[name="conditions_to_approve[terms-and-conditions]"]:checked').val() == 'undefined'){
//                $('#ps_checkout-binary-form').css("pointer-events", "none");
//            }
//        $('#ps_checkout-hosted-fields-form').show();
//                $('#supercheckout_confirm_order').hide();
//                $('#payment_methods_binaries').show();
//                $('#ps_checkout-binary-form').show();
//                if ($('input:radio[name="payment_method"]:checked').attr('id') == 'payment-option-1-card') {
//                    $('#button-paypal').hide();
//                    $('#button-card').show();
//                    $('#payment-option-1-card-additional-information').show();
//                } else {
//                    $("#ps_checkout-binary-form .alert").show();
//                    $('#button-paypal').show();
//                    $('#button-card').hide();
//                    $('#payment-option-1-card-additional-information').hide();
//                }
//            } else {
////        $('#ps_checkout-hosted-fields-form').hide();
//                $('#payment_methods_binaries').hide();
//                $('#supercheckout_confirm_order').show();
//                $('#ps_checkout-binary-form').hide();
//            }
...
//            console.log(profile_data['shipping_address'][i]['id']);
//            console.log(profile_data['shipping_address'][i]['customer']['display']);
//            console.log(profile_data['shipping_address'][i]['customer']['require']);
//             console.log($('input[name="shipping_address['+profile_data['shipping_address'][i]["id"]+']"]').length); 
